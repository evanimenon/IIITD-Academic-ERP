        ...
        if (sections.isEmpty()) {
            ...
            for (SectionInfo sec : sections) {
                ...
                viewBtn.addActionListener(
                        e -> new SectionInfoPage(instructorId, sec.sectionID, userDisplayName).setVisible(true));
                ...
                manageBtn.addActionListener(
                        e -> new ManageComponents(instructorId, sec.sectionID, userDisplayName).setVisible(true));
